...
***Further read***: **[Learn more about how to generate Living Documentation](https://docs.specflow.org/projects/specflow-livingdoc/en/latest/LivingDocGenerator/Generating-Documentation.html)**", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [Xunit.TraitAttribute("Category", "Scenario-1")]
        [Xunit.TraitAttribute("Category", "Addition")]
        [Xunit.InlineDataAttribute("50", "70", "120", new string[0])]
        [Xunit.InlineDataAttribute("10", "10", "20", new string[0])]
        [Xunit.InlineDataAttribute("0", "-20", "-20", new string[0])]
...
#line hidden
        ...
        [Xunit.TraitAttribute("Category", "Scenario-2")]
        [Xunit.TraitAttribute("Category", "Subtraction")]
        [Xunit.InlineDataAttribute("50", "70", "-20", new string[0])]
        [Xunit.InlineDataAttribute("10", "10", "0", new string[0])]
        [Xunit.InlineDataAttribute("0", "-20", "20", new string[0])]
        public virtual void SubtractTwoNumbers(string firstNum, string secondNum, string result, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "Scenario-2",
                    "Subtraction"};
